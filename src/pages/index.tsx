...
export default function Home(props : HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 items-center gap-28'>
      ...
      <div className='mt-10 pd-10 border-t border-gray-600 flex items-center justify-between text-gray-100'>
      ...
      <Image
        src={appPreviewImage}
        alt="Dois celulares mostrando uma prévia da aplicação móvel NLW Copa" 
        quality={100}
      />
    </div>
  )
